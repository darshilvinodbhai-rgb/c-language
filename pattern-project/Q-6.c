...
// i=3  3<=5  j=1  1<=3  print:1 2 3  space=1  1<=4  print:4 spaces  j=3  3>=1  print:3 2 1
// i=4  4<=5  j=1  1<=4  print:1 2 3 4  space=1  1<=2  print:2 spaces  j=4  4>=1  print:4 3 2 1
